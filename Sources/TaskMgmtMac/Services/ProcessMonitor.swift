    ...
    func currentSnapshot(includesProcesses: Bool) async -> ProcessSnapshot {
        ...
        return ProcessSnapshot(
            summary: ProcessSummary(
                ...
                memoryCachedBytes: sample.memoryUsage.cachedBytes,
                memoryWiredBytes: sample.memoryUsage.wiredBytes,
                memorySwapUsedBytes: sample.memoryUsage.swapUsedBytes,
                memorySwapTotalBytes: sample.memoryUsage.swapTotalBytes,
                disk: 0,
                network: 0,
                gpu: 0,
